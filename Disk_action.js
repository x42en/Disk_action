...
(function() {
  ...
  module.exports = Disk_action = (function() {
    ...
    Disk_action.prototype.write = function(_arg) {
      var cb, content, dirname, filename, _ref;
      _ref = _arg != null ? _arg : {}, filename = _ref.filename, dirname = _ref.dirname, content = _ref.content, cb = _ref.cb;
      if (cb != null) {
        ...
        return console.error('NOARGS');
      }
    };

    Disk_action.prototype.append = function(_arg) {
      var cb, content, filename, _ref;
      _ref = _arg != null ? _arg : {}, filename = _ref.filename, content = _ref.content, cb = _ref.cb;
    ...
    Disk_action.prototype.copy = function(_arg) {
      var cb, destination, source, _ref;
      _ref = _arg != null ? _arg : {}, source = _ref.source, destination = _ref.destination, cb = _ref.cb;
    ...
    Disk_action.prototype.replace = function(_arg) {
      var cb, filename, replace_with, to_replace, _ref;
      _ref = _arg != null ? _arg : {}, filename = _ref.filename, to_replace = _ref.to_replace, replace_with = _ref.replace_with, cb = _ref.cb;
      if ((filename != null) && (to_replace != null) && (cb != null)) {
    ...
    Disk_action.prototype["delete"] = function(_arg) {
      var cb, filename, _ref;
      _ref = _arg != null ? _arg : {}, filename = _ref.filename, cb = _ref.cb;
